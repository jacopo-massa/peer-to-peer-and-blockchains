...
public class World {
	...
	public World(List<DTNHost> hosts, int sizeX, int sizeY,
		...
		try {
			this.patchTime = s.getDouble("patchTime");
			this.nextPatchTime = SimClock.getIntTime() + this.patchTime;
		} catch (SettingsError se) {
			System.err.println("Failed to find '" + SIR_NS + "patchTime");
